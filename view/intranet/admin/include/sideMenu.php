      ...
      <ul class="sidebar navbar-nav">
            ...
            <!-- <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                <a class="dropdown-item" href="moveNew.php">Registrar</a>
                <a class="dropdown-item" href="moveManage.php">Administrar</a>
                <a class="dropdown-item" href="barChartEntry.php">Gráfico Ingreso</a>
                <a class="dropdown-item" href="barChartExit.php">Gráfico Egreso</a>
              </div>
            </li> -->
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fa fa-newspaper pr-2"></i>
                <span>Noticias</span>
              </a>
              <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                <a class="dropdown-item" href="newNews.php"><i class="fa fa-plus text-info pr-3"></i>Crear noticia</a>
                <a class="dropdown-item" href="newsManage.php"><i class="fa fa-address-card text-info pr-3"></i>Editar noticia</a>
                </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
