    ...
    <div class="son-register-page">
        ...
        <div class="container">
            ...
            <div class="buscar-padre">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Ejemplo: 10924201-k" aria-label="Search" aria-describedby="basic-addon2"
                        id="buscar_padre_input">
                    <div class="input-group-append width">
                        <button class="btn btn-secondary" type="button" id="buscar_padre_button">
            ...
            <div class="row my-5" id="contenedor_padre">
                <div class="col-md-5 animated fadeIn info_trabajador d-none">
                    ...
                    <div class="card profile" style="width: 100%">
                        <div class="card container-image">
                            ...
                            <div class="object-fill">
                                <img src="../../../assets/images/500x500.png" alt="..." class="img-thumbnail cover rounded-circle" id="url_foto">
                            </div>
                ...
                <div class="col-md-7 animated fadeIn info_hijo d-none">
