...
$(function () {
    if ($('body').hasClass('sonManageProfile')) {

    } else if ($('body').hasClass('sonNewProfile')) {
            ...
            success: function (response) {
                setTimeout(function () {
                    try {
                        ...
                        if (json.clase == "danger") {
                            $('.no-registros').html("No tiene hijos registrados").addClass("py-3");
